...
/**
 * A data class representing one single extended status of a user.
 */
/*package*/ final class ExtendedStatusJSONImpl extends TwitterResponseImpl implements Status, java.io.Serializable {
    private static final Logger logger = Logger.getLogger(ExtendedStatusJSONImpl.class);
    private static final long serialVersionUID = -8575749851041554143L;
    ...
    /*package*/ExtendedStatusJSONImpl(HttpResponse res, Configuration conf) throws TwitterException {
        super(res);
    ...
    /*package*/ExtendedStatusJSONImpl(JSONObject json, Configuration conf) throws TwitterException {
        super();
        init(json);
        if (conf.isJSONStoreEnabled()) {
            TwitterObjectFactory.registerJSONObject(this, json);
    ...
    /*package*/ ExtendedStatusJSONImpl(JSONObject json) throws TwitterException {
        super();
        init(json);
    }

    /* Only for serialization purposes. */
    /*package*/ ExtendedStatusJSONImpl() {
    ...
    private void init(JSONObject json) throws TwitterException {
        ...
        try {
            ...
            if (!json.isNull("retweeted_status")) {
                retweetedStatus = new ExtendedStatusJSONImpl(json.getJSONObject("retweeted_status"));
            }
            ...
            if (!json.isNull("quoted_status")) {
                quotedStatus = new ExtendedStatusJSONImpl(json.getJSONObject("quoted_status"));
            }
    ...
    static ResponseList<Status> createStatusList(HttpResponse res, Configuration conf) throws TwitterException {
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Status status = new ExtendedStatusJSONImpl(json);
                if (conf.isJSONStoreEnabled()) {
